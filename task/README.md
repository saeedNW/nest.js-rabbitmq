...
The task manager service is a RabbitMQ microservice built with the NestJS framework. It is designed to handle all task-related operations within the system, serving as a dedicated module for managing tasks. This microservice communicates with the core application via RabbitMQ, enabling seamless integration and efficient task management.
